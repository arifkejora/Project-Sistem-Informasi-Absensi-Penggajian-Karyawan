...
if (isset($_POST['submit'])) {
  ...
  // simpan data ke dalam tabel "gatot"
  $query = "INSERT INTO gatot (id_karyawan, nama, jabatan, bulan, tahun, total_lembur, gaji_total)
            VALUES ('".$data['id_karyawan']."', '".$data['nama']."', '".$data['jabatan']."', '".$bulan."', '".$tahun."', '".$data['total_lembur']."', '".$data['gaji_sementara']."')";
  ...
  echo "Data berhasil disimpan ke dalam tabel 'gatot'.";
}
