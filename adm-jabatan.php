                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="jabatan_save.php" method="post">
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" name="gaji" autocomplete="off">
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-striped">
                                ...
                                <tr>
                                                ...
                                                <td> 
                                                    <a href="jabatan_del.php?id=<?php echo $row['id']; ?>"><button class="btn btn-danger" onclick="return confirm('yakin ingin dihapus?');">Hapus</button></a>
                                                </td>
                                </tr>
                                <?php 
                                       }
