        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Riwayat Presensi Harian</h5>

                            <!-- Default Table -->
                                                        <?php
                            include 'koneksi.php';
                            $id_karyawan = $_SESSION['idsi'];
                            $query = "SELECT * FROM tb_absen WHERE id_karyawan = '$id_karyawan'";
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Riwayat Presensi Lembur</h5>

                            <!-- Table with stripped rows -->
                            <?php
                            include 'koneksi.php';
                            $id_karyawan = $_SESSION['idsi'];
                            $query = "SELECT * FROM tb_lembur WHERE id_karyawan = '$id_karyawan'";
                            $result = mysqli_query($koneksi, $query);
                            ?>
