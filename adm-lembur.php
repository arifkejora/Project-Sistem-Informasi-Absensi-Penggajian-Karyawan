        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Tambah Data Lembur</h5>
                            <form action="lembur_save.php" method="post">
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label">Upah Lembur</label>
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" name="uanglembur" autocomplete="off">
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <?php 
                                        include 'koneksi.php';
                                        $sql = "SELECT j.jabatan, u.uanglembur, u.id FROM tb_jabatan j JOIN tb_uanglembur u ON j.id = u.id_jabatan";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td> 
                                                    <a href="lembur_del.php?id=<?php echo $row['id']; ?>"><button class="btn btn-danger" onclick="return confirm('yakin ingin dihapus?');">Hapus</button></a>
                                                </td>
                                        </tr>
                                    <?php 
                                        }
