        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Tambah Data Potongan</h5>
                            <form action="potongan_save.php" method="post">
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" name="potongan" autocomplete="off">
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <?php 
                                        include 'koneksi.php';
                                        $sql = "SELECT j.jabatan, u.potongan, u.id FROM tb_jabatan j JOIN tb_potongan u ON j.id = u.id_jabatan";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td> 
                                                    <a href="potongan_del.php?id=<?php echo $row['id']; ?>"><button class="btn btn-danger" onclick="return confirm('yakin ingin dihapus?');">Hapus</button></a>
                                                </td>
                                        </tr>
                                    <?php 
                                        }
